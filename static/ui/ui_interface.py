...
from PyQt5.QtGui import (QBrush, QColor, QConicalGradient, QCursor, QFont,
    ...
    QRadialGradient, QPainterPath, QRegion)
from PyQt5.QtWidgets import *
from PyQt5.QtWebEngineWidgets import QWebEngineView

class QPlayer(QWebEngineView):
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.centralwidget.setStyleSheet(u"background: url(static/icons/background.png); background-repeat: no-repeat")
        ...
        self.background.setStyleSheet(u"background: url(static/icons/home_interface.png);")
        ...
        self.func_menu = QFrame(self.background)
        self.func_menu.setObjectName(u"func_menu")
        self.func_menu.setGeometry(QRect(-800, 190, 800, 600))
        self.func_menu.setStyleSheet(u"background: none; margin: 0px; padding: 0px;")
        self.func_menu.setFrameShape(QFrame.StyledPanel)
        self.func_menu.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_1 = QHBoxLayout(self.func_menu)
        self.horizontalLayout_1.setObjectName(u"horizontalLayout_1")
        self.horizontalLayout_1.setSpacing(0)
        self.min_browser = QToolButton(self.func_menu)
        self.min_browser.setObjectName(u"min_browser")
        self.min_browser.setStyleSheet(u"QToolButton{background: rgba(34, 224, 239, 100); color: rgb(34, 224, 239); border-top-right-radius: 10px; border-bottom-right-radius: 10px; font: 20pt \"Orbitron\";} QToolButton::hover{background: rgba(34, 224, 239, 200); color: rgb(250, 223, 113)}")
        self.min_browser.setFixedSize(QSize(30, 576))

        self.horizontalLayout_1.addWidget(self.min_browser)

        self.browser = QWebEngineView(self.func_menu)
        self.browser.setStyleSheet(u"QWidget{border-top-left-radius: 10px; border-bottom-left-radius: 10px;}")
        self.browser.setContextMenuPolicy(Qt.NoContextMenu)  
        self.horizontalLayout_1.addWidget(self.browser)

        self.command_menu = QFrame(self.background)
        self.command_menu.setObjectName(u"command_menu")
        self.command_menu.setGeometry(QRect(20, 190, 431, 481))
        self.command_menu.setStyleSheet(u"background: url(\"J:/Program_Development/Python/Python_Projects/Projects/Virtual_AI_Assistant/Mark_5/static/icons/left_menu3.png\"); background-position: center; background-repeat: no-repeat; margin: 10px;")
        ...
        self.command_title.setFixedSize(QSize(390, 75))
        self.command_title.setStyleSheet(u"background: none; color: rgb(250, 223, 113); font: 16pt \"Orbitron\"; padding-top: 10px; padding-bottom: 0px;")
        self.command_title.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)
        ...
        self.command_list.setFixedSize(QSize(390, 390))
        self.command_list.setStyleSheet(u"QListWidget{background: none; background-color: rgba(34, 224, 239, 0); border: none; border-top-right-radius: 30px; color: rgb(255, 255, 255); font: 14pt \"Orbitron\"; text-align:left; padding: 20px; padding-top: 0px; margin-left: 10px; margin-right: 40px; margin-bottom:40px;} QListWidget::item:selected{background: rgba(250, 223, 113, 100); border-left: 7px solid rgb(250, 223, 113); border-top: 2px solid rgb(250, 223, 113)} QListWidget::item{padding: 10px; padding-left: 10px; border-bottom: 2px solid rgb(250, 223, 113);}")
        ...
        self.settings_menu.setStyleSheet(u"QToolButton{background: rgba(34, 224, 239, 100); color: rgb(34, 224, 239); border-radius: 5px;  font: 8pt \"Orbitron\";} QToolButton::hover{background: rgba(34, 224, 239, 200); color: rgb(250, 223, 113)}")
        ...
        self.network_menu.setStyleSheet(u"QToolButton{background: rgba(34, 224, 239, 100); color: rgb(34, 224, 239); border-radius: 5px;  font: 8pt \"Orbitron\";} QToolButton::hover{background: rgba(34, 224, 239, 200); color: rgb(250, 223, 113)}")
        ...
        self.home_menu.setStyleSheet(u"QToolButton{background: rgba(34, 224, 239, 100); color: rgb(34, 224, 239); border-radius: 5px;  font: 8pt \"Orbitron\";} QToolButton::hover{background: rgba(34, 224, 239, 200); color: rgb(250, 223, 113)}")
        ...
        self.close_button.setStyleSheet(u"QToolButton{background: rgba(236, 77, 89, 230); border-radius: 30px; color: white; border: 10px solid rgba(236, 77, 89, 100); font-size: 20pt;} QToolButton::hover{background: rgba(211, 52, 64, 230); border: 10px solid rgba(211, 52, 64, 100)}")
        ...
        self.player_label = QPlayer(self.background)
        self.player_label.setObjectName(u"player_label")
        self.player_label.setGeometry(QRect(40, 800, 400, 80))
        # self.player_label.setContextMenuPolicy(Qt.NoContextMenu)
        # self.player_label.setStyleSheet(u"background: none; color: rgb(255, 255, 255); font: 14pt \"Orbitron\";")
        # self.player_label.load(QUrl.fromLocalFile(""))
        self.player_label.setAttribute(Qt.WA_TranslucentBackground)
        # self.player_label.setStyleSheet("background: none; border: 2px solid white; border-radius: 5px")
        # self.player_label.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOff)  
        # self.player_label.load(QUrl.fromLocalFile("J:/Program_Development/Python/Python_Projects/Projects/Virtual_AI_Assistant/Mark_7/features/libraries/template/media.html"))
        # self.player_label.setAlignment(Qt.AlignCenter)
        # self.player_label.setSource(QUrl.fromLocalFile("J:/Program_Development/Python/Python_Projects/Projects/Virtual_AI_Assistant/Mark_6/features/libraries/template/loader.html"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.min_browser.setText(QCoreApplication.translate("MainWindow", u">", None))
        ...
        self.ping_label.setText(QCoreApplication.translate("MainWindow", u"", None))
    # retranslateUi
